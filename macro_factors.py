...
def build_factor_snapshot(observations: Iterable[MacroObservation], *, as_of: datetime) -> MacroFactorSnapshot:
    ...
    factors: dict[str, float | None] = {
        ...
        "jgb_curve_2s10s_bp": None if jgb2 is None or jgb10 is None else (jgb10-jgb2)*100.0,
        "jgb_curve_10s30s_bp": None if jgb10 is None or jgb30 is None else (jgb30-jgb10)*100.0,
        "us_jp_10y_spread_bp": None if us10 is None or jgb10 is None else (us10-jgb10)*100.0,
